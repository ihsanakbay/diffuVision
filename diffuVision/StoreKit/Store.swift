...
class Store: ObservableObject {
	...
	private let productIdToValue: [String: String]

	init() {
		productIdToValue = Store.loadProductIdToValue()
	...
	static func loadProductIdToValue() -> [String: String] {
		guard let path = Bundle.main.path(forResource: "StoreKitProperty", ofType: "plist"),
	...
	func requestProducts() async {
		do {
			...
			let storeProducts = try await Product.products(for: productIdToValue.keys)
